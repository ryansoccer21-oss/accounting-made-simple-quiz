...
export const quizzes: Quiz[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      q("afe-003", "You want to copy a formula down while always multiplying by the tax rate in cell F1. Which reference should lock F1?", ["F1", "$F$1", "F$", "$F", "F1:F1"], "B", "The dollar signs in $F$1 lock both the column and row."),
